package com.protone.layout.view.blur;

import static com.protone.layout.view.blur.BlurController.DEFAULT_SCALE_FACTOR;
...
public final class RenderScriptBlur implements BlurAlgorithm {
    ...
    public final Bitmap blur(Bitmap bitmap, float blurRadius) {
        ...
        Allocation inAllocation = Allocation.createFromBitmap(renderScript, bitmap, Allocation.MipmapControl.MIPMAP_NONE,
                Allocation.USAGE_SHARED | Allocation.USAGE_SCRIPT | Allocation.USAGE_GRAPHICS_TEXTURE);
